...
public class ChildAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			viewHolder.mImageView = (HeartImageView) convertView.findViewById(R.id.child_image);
			viewHolder.mCheckBox = (CheckBox) convertView.findViewById(R.id.child_checkbox);
			
			//用来监听ImageView的宽和高
			viewHolder.mImageView.setMeasureListener(new OnMeasureListener() {
	...
	public HashSet<String> getSelectedPath()
	{
		...
		for(Iterator<Map.Entry<Integer, Boolean>> it = mSelectMap.entrySet().iterator(); it.hasNext();)
		{
			...
			if(entry.getValue())
			{
				result.add(list.get(entry.getKey()));
			}
		}
	...
	public static class ViewHolder{
		public  HeartImageView mImageView;
